...
function M.setup(opts)
  ...
  Color.new("base03", "#282828")
  Color.new("base02", "#3c3836")
  Color.new("base01", "#504945")
  Color.new("base00", "#665c54")
  Color.new("base0", "#bdae93")
  Color.new("base1", "#d5c4a1")
  Color.new("base2", "#ebdbb2")
  Color.new("base3", "#fbf1c7")
  Color.new("yellow", "#fabd2f")
  Color.new("orange", "#fe8019")
  Color.new("red", "#fb4934")
  Color.new("magenta", "#d3869b")
  Color.new("violet", "#b16286")
  Color.new("blue", "#83a598")
  Color.new("cyan", "#8ec07c")
